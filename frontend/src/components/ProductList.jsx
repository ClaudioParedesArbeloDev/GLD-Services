...
export default function ProductList({ products }) {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 w-8/9 mx-auto md:w-full">
      {products.map((product) => {
        ...
        return (
          ...
          >
            ...
            <div className="relative bg-linear-to-br from-gray-100 to-blue-50/30 aspect-square overflow-hidden">
              <img
              ...
              {discount > 0 && (
                <div className="absolute top-3 right-3 bg-linear-to-r from-red-500 to-red-600 text-white px-3 py-1.5 rounded-full text-xs font-bold shadow-xl flex items-center gap-1">
              ...
              {product.stock < 5 && product.stock > 0 && (
                <div className="absolute top-3 left-3 bg-linear-to-r from-yellow-400 to-yellow-500 text-white px-3 py-1.5 rounded-full text-xs font-bold shadow-xl">
                  ¡Últimas unidades!
                </div>
              )}
              ...
              {product.stock === 0 && (
                <div className="absolute inset-0 bg-black/30 flex items-center justify-center backdrop-blur-[2px]">
                  <span className="bg-red-600 text-white px-6 py-3 rounded-xl font-bold text-sm shadow-xl">
                    <i className="fa-solid fa-truck-fast px-2"></i>
                    Proximamente
                  </span>
                </div>
              )}
            ...
            <div className="p-5">
              ...
              <h3 className="text-lg font-bold text-gray-800 mb-3 line-clamp-2 group-hover:text-blue-600 transition-colors min-h-14">
                {product.title}
              </h3>
              ...
              <button className="w-full bg-linear-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white py-3 rounded-xl font-bold transition-all duration-300 transform group-hover:scale-105 shadow-lg hover:shadow-xl flex items-center justify-center gap-2">
